    ...
    return(
        <div className="content1">
            ...
            <div className='texto1'>
                A diferencia de cualquier deporte, el único objetivo del yoga es encontrar la mejor versión de uno mismo, y su práctica debe hacerse de manera honesta, exigiéndonos pero sin llegar a forzar ni juzgarnos en ningún momento. <br />
